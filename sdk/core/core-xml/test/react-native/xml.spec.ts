 ...
 * These tests verify the XML API works correctly when resolved through
 * the react-native condition in the #platform/xml imports map.
 */
describe("XML serializer (react-native)", function () {
